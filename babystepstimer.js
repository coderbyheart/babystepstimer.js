...
var BACKGROUND_COLOR_NEUTRAL = '#ffffff';
var BACKGROUND_COLOR_FAILED = '#ffcccc';
var BACKGROUND_COLOR_PASSED = '#ccffcc';
var bodyBackgroundColor = BACKGROUND_COLOR_NEUTRAL;

var SECONDS_IN_CYCLE = 120;

var twoDigitsFormat = function twoDigitsFormat(number) {
  return ('0' + Math.floor(number)).slice(-2);
};

var timerDisplay = $('#timeleft');
var timer = $('#timer');
var quitButton = $('#quit');
...
var Babysteptimer = function () {
  function Babysteptimer() {
    _classCallCheck(this, Babysteptimer);
  ...
  _createClass(Babysteptimer, null, [{
    key: 'updateTimer',
    value: function updateTimer(time, color, running) {
    ...
    key: 'getRemainingTimeCaption',
    value: function getRemainingTimeCaption(elapsedTime) {
      var elapsedSeconds = elapsedTime / 1000;
      var remainingSeconds = SECONDS_IN_CYCLE - elapsedSeconds;
  ...
  return Babysteptimer;
}();

var timerRunning = false;
var currentCycleStartTime = void 0;
var lastRemainingTime = void 0;

/**
 * TODO: Maybe use requestAnimationFrame
 */

var TimerThread = function () {
  function TimerThread() {
    _classCallCheck(this, TimerThread);
  }

  _createClass(TimerThread, [{
    key: 'start',
    ...
    value: function run() {
      ...
      this.interval = window.setInterval(function () {
        ...
        var elapsedTime = Date.now() - currentCycleStartTime;
        ...
        var remainingTime = Babysteptimer.getRemainingTimeCaption(elapsedTime);
